...
begin
    ...
    begin
        case current_state is
            ...
            when RECEIVE =>
                if counter_i = unsigned(image_dim)*unsigned(image_dim) - 1 then
            ...
            when OUTPUTING =>
                if counter_i = unsigned(image_dim)*unsigned(image_dim) + 2*unsigned(image_dim) + 2 then
    ...
    begin
        if rising_edge(clk) then
            ...
            if current_state = IDLE then
                ...
                if valid_in = '1' or counter_i = unsigned(image_dim)*unsigned(image_dim) - 1 then
